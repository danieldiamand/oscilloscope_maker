...
from rotateVertex import rotateVerticies
...
class Line:
    def __init__(self, x1,y1,x2,y2, speed = 20):
        self.x1 = x1*scale
        self.y1 = y1*scale
        self.x2 = x2*scale
        self.y2 = y2*scale
...
vertices = rotateVerticies(vertices, initRotation)
...
with wave.open(saveFileName+".wav", "w") as f:
    ...
    for _ in range(rotations):
        ...
        vertices = rotateVerticies(vertices, rotationArray)
